...
const WAYPOINTS := {
	# Points décalés temporairement (preview) pour voir un cratère RockSlide
	# sans que le joueur ne se tienne dessus (vue dégagée).
	"level_16": [800.0, 1900.0, 3600.0, 5000.0, 6950.0],
	"level_17": [230.0, 2020.0, 4340.0, 6050.0, 6650.0],
	"level_18": [100.0, 1300.0, 4700.0, 6370.0, 7150.0],
