...
## ils enseignent les commandes au bon moment, sans bloquer le jeu. Postés
## juste avant que la mécanique ne serve (premier ennemi, premier checkpoint).
func _build_tutorial_signs() -> void:
	var signs := [
		{"x": 150.0, "text": "◄  ►   Se déplacer"},
		{"x": 470.0, "text": "▲  Sauter (maintenir = plus haut)"},
		{"x": 1270.0, "text": "Épée   Trancher les esprits"},
		{"x": 1500.0, "text": "Ruée   Invincible, traverse les ennemis"},
	]
	for s in signs:
